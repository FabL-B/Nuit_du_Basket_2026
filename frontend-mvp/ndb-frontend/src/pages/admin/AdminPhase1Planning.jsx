...
export default function AdminPhase1Planning() {
  ...
  const genPlanningM = useMutation({
    mutationFn: () => adminApi.genererPlanningPhase(phase1.id),
  ...
  if (!phase1) return <EmptyState label="Phase 1 introuvable." />;

  return (
    <div className="stack">
      <div className="card">
        <div className="title">Phase 1 — Planning</div>
