...
def test_sheet_code_unique():
    ...
    m1 = Match.objects.create(edition=edition, phase_globale=phase, sous_phase=sous_phase, groupe=groupe, equipe_a=e1, equipe_b=e2)
    m2 = Match.objects.create(edition=edition, phase_globale=phase, sous_phase=sous_phase, groupe=groupe, equipe_a=e1, equipe_b=e3)
