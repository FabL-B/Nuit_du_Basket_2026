...
def setup_groupe_et_classement():
    ...
    Classement.objects.create(
        groupe=g, equipe=e1, points_classement=6, difference=5, points_marques=30
    )
    Classement.objects.create(
        groupe=g, equipe=e2, points_classement=6, difference=10, points_marques=25
    )
    Classement.objects.create(
        groupe=g, equipe=e3, points_classement=3, difference=-2, points_marques=10
    )
